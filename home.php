    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card shadow-sm h-100 d-flex flex-column">
        <div class="card-body d-flex flex-column">
          ...
          <div class="mt-auto">
            <a href="usuarios/usuarios.php" class="btn btn-secondary w-100">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card shadow-sm h-100 d-flex flex-column">
        <div class="card-body d-flex flex-column">
          ...
          <div class="mt-auto">
            <a href="vendas/vendas.php" class="btn btn-secondary w-100">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card shadow-sm h-100 d-flex flex-column">
        <div class="card-body d-flex flex-column">
          ...
          <div class="mt-auto">
            <a href="estoque/estoque.php" class="btn btn-secondary w-100">
